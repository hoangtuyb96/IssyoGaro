...
UserGoal.create!(user_id: 1, goal_id: 1, user_group_id: 1, process: 0.8)
UserGoal.create!(user_id: 2, goal_id: 1, user_group_id: 2, process: 1)
UserTask.create!(user_id: 1, task_id: 1, user_goal_id: 1,process: 1, evaluate_user_id: 2)
UserTask.create!(user_id: 1, task_id: 2, user_goal_id: 1,process: 0.9, evaluate_user_id: 2)
UserTask.create!(user_id: 2, task_id: 1, user_goal_id: 2,process: 1, evaluate_user_id: 1)
UserTask.create!(user_id: 2, task_id: 2, user_goal_id: 2,process: 1, evaluate_user_id: 1)
